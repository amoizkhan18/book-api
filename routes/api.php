...
// ✅ Public reading routes — generous limit (120/min)
Route::middleware(['throttle:120,1'])->group(function () {
    ...
    Route::get('/recommendations/popular', [RecommendationController::class, 'getPopular']);
});

// ✅ Activity & recommendation routes — moderate limit (60/min)
...
// ✅ Notification sending routes — strict limit (10/min)
...
// ✅ Admin content management routes — strict limit (30/min)
